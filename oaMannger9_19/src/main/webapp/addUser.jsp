		...
		<div class="am-cf admin-main">
			<div class="admin-content">
				<div class="admin-content-body">
					<div class="am-g">
						<form class="am-form am-form-horizontal" action="/employee/insertEmployee.do" method="post" target="right" style="padding-top: 30px;">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input id="ename" type="text" name="ename" placeholder="请输入用户用户名"  />
									<small>输入用户名。</small>
								</div>
							</div>
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input id="epass" type="password" name="epass" placeholder="请输入用户密码"  />
									<small>输入密码。</small>
								</div>
							</div>
							<div class="am-form-group">
